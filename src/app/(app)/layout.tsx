    ...
    <div className="flex min-h-screen bg-[#09090B]">
      ...
      <aside className="fixed inset-y-0 left-0 w-[220px] border-r border-white/[0.07] bg-[#09090B] flex flex-col z-30">
        ...
        <nav className="flex-1 px-3 py-4 space-y-0.5 overflow-y-auto">
          <a
            href="/dashboard"
            className="flex items-center gap-2.5 rounded-lg px-3 py-2 text-[13px] font-medium text-white bg-white/[0.06]"
          >
          ...
          <a
            href="/invoices"
            className="flex items-center gap-2.5 rounded-lg px-3 py-2 text-[13px] font-medium text-zinc-400 hover:text-white hover:bg-white/[0.04] transition-colors"
          >
            <svg className="w-4 h-4 opacity-70" fill="none" viewBox="0 0 24 24" stroke="currentColor">
